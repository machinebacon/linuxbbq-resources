...
#this requires memstat.sh and battstat.sh 
#echo "RAM used: "$(/usr/local/bin/memstat.sh)"M Battery: "$(/usr/local/bin/battstat.sh)"%"
...
if [ "$color_prompt" = yes ]; then
	PS1="\[\033[0;37m\]\][\[\033[0;35m\]\$(/usr/local/bin/battstat.sh)\033[0;37m\]]\342\224\200[\[\033[0;31m\]\[\A\[\033[0;37m\]]\342\224\200[\[\033[0;32m\]\w\[\033[0;37m\]]\n\[\033[0;37m\]\342\224\224\342\224\200\342\224\200\342\224\200\342\224\200\342\225\274 \[\033[0m\]"
else
...
alias moc='mocp -T darkdot_theme'
